      ...
      {/* 팝업 채팅창 */}
        ...
        <div className={styles.popup}>
          ...
          {/* 채팅 바디 */}
            ...
            {messages.map((msg) => (
                <div key={msg.id} className={msg.type === "ai" ? styles.msgAi : styles.msgUser}>
                {msg.type === "ai" && (
                ...
                <div>
                    <div className={msg.type === "ai" ? styles.bubbleAi : styles.bubbleUser}>
                    {msg.text.split("\n").map((line, i) => (
                        <span key={i}>
                        {line}
                        <br />
...
const CherryBlossomIcon = ({ size, speed }) => {
    ...
    <svg width={size} height={size} viewBox="0 0 44 44" fill="none">
      ...
      {/* 바깥 꽃잎 */}
        ...
        <ellipse cx="22" cy="7.5" rx="5" ry="8" fill="#f9a8d4" opacity="0.9" transform="rotate(0 22 22)" />
        <ellipse cx="22" cy="7.5" rx="5" ry="8" fill="#ec4899" opacity="0.75" transform="rotate(72 22 22)" />
        <ellipse cx="22" cy="7.5" rx="5" ry="8" fill="#f9a8d4" opacity="0.9" transform="rotate(144 22 22)" />
        <ellipse cx="22" cy="7.5" rx="5" ry="8" fill="#ec4899" opacity="0.75" transform="rotate(216 22 22)" />
        <ellipse cx="22" cy="7.5" rx="5" ry="8" fill="#f9a8d4" opacity="0.9" transform="rotate(288 22 22)" />
        </g>
      ...
      {/* 얼굴 표정 */}
        ...
        <path d="M19.5 24 Q22 26 24.5 24" stroke="#e879a0" strokeWidth="1.1" strokeLinecap="round" fill="none" />
        <ellipse cx="17" cy="23.5" rx="2.5" ry="1.5" fill="#fda4af"
            style={{ animation: "blushPulse 2s ease-in-out infinite", opacity: 0.6 }} />
        <ellipse cx="27" cy="23.5" rx="2.5" ry="1.5" fill="#fda4af"
            style={{ animation: "blushPulse 2s ease-in-out infinite 0.5s", opacity: 0.6 }} />
        </g>
